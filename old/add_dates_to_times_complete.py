...
# Save to CSV
result_df.to_csv('pig_timestamps_complete.csv', index=False)

print("Complete extraction with all pigs completed!")
print(f"Extracted {len(result_df)} rows")
print(f"Columns: {list(result_df.columns)}")

# Show pig count comparison
excel_pigs = set(df[df['Unnamed: 0'].str.startswith('CO-', na=False)]['Unnamed: 0'].unique())
...
# Show sample data for CO-038
print("\nSample data for CO-038:")
sample_pig = result_df[result_df['pig_id'] == 'CO-038']
